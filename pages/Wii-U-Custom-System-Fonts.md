...
This page provides a few Fontworks fonts for Wii U. If you want a collection of
...
<details class="expandable-details">
  ...
  <p>
    ...
    <br>
    Both tweaks are included in the Wii U system font to avoid text
    clipping/wrapping.
  </p>
</details>
...
<div id="Wii-U_Install" class="tabcontent_0">
  ...
  <div class="note-blue">
    <p>
      ...
      system font is loaded into RAM only, so it's safe to install a custom
      system font without worrying about bricking the console.
    </p>
  </div>
