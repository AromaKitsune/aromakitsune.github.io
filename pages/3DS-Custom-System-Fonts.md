...
This page provides a few Fontworks fonts for 3DS. If you want a collection of
these OTF fonts for other uses, you can get them from the
...
It is used for the UI in many Nintendo games. It is also used for the tutorial 
sections in Hyperdimension Neptunia games for the PlayStation 3.
...
- [TTF - for anything else](/files/PopJoyStd-B_Scaled.ttf) (Fixed side-bearings
                            + Scaled)
...
<details class="expandable-details">
  ...
  <p>
    ...
    <br>
    Both tweaks are included in the 3DS system font to avoid text
    clipping/wrapping.
  </p>
</details>
...
It is used for the UI in various Nintendo games, WarioWare games, and Hatsune
Miku: Colorful Stage!.
...
<div id="3DS_Install" class="tabcontent_0">
  ...
  <div class="note-blue">
    <p>
      ...
      protection, allowing recovery with GodMode9.
  ...
  <details class="expandable-details">
    ...
    <p>
      The method to install a custom system font is installing a
      <code>.cia</code> file which replaces a system file. I tried a safer
      method; LayeredFS, a Luma3DS feature that redirects games assets to modded
      assets files in the SD Card without patching the ROMs directly, but it
      currently doesn't work with a system font, so we have to modify a system
      file instead.
    </p>
  </details>
...
<div class="container_gallery">
  ...
  <div class="mySlides_gallery" align="center">
    ...
    Hyperdimension Neptunia Victory / Re;Birth3: V Generation
    <br>
    Pop Happiness font used for the &quot;Teach Me, Histy!&quot; display text,
    it is shown each time a tutorial is unlocked.
    <br>
    <br>
  </div>
