...
<div id="3DS_Install" class="tabcontent_1">
  ...
  <div class="note-blue">
    <p>
      This mod will be installed with LayeredFS, a Luma3DS feature that
      redirects games/apps assets to modded assets files in the SD Card without
      patching the ROMs or system files directly.
    </p>
    <p>
      Luma3DS v13.4 or above is required.
    </p>
  </div>
...
<div id="CIA_File_Uninstall" class="tabcontent_fullwidth_1">
  ...
  <div class="note-blue">
    <p>
      If you have the patched Home Menu applet installed in the past, follow
      this instruction.
    </p>
  </div>
